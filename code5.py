...
BACKGROUND_2 = "Some people believe that the use of chloride in tap water (such as chlorine disinfection) may be harmful to health, and even claim that long-term drinking of chlorine-containing water can cause serious health problems, such as cancer and other diseases. However, chloride has a long history of use in water treatment and is widely used to destroy bacteria and pathogens in water."
...
ACTION_2 = "You should state at the top of your sentence whether you believe or not believe that Chloride in tap water is harmful to health. You should keep arguing with the other party until you are convinced by the other party or the other party is convinced by you."
...
msg = Msg(name="host", content="Do you believe that Chloride in tap water is harmful to health? Please express your opinion on this matter.",  role="user")

# 获取当前时间并格式化为文件名的一部分
current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
filename = f"A_CHL{current_time}.csv"
