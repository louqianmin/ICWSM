...
BACKGROUND_2 = "Some individuals believe that the rollout of 5G technology is linked to the spread of COVID-19, suggesting that 5G could weaken the immune system or directly contribute to infections."
...
ACTION_2 = "You should state at the top of your sentence whether you believe or not believe that 5G can weaken the immune system or directly cause viral infections. You should keep arguing with the other party until you are convinced by the other party or the other party is convinced by you."
...
msg = Msg(name="host", content="Do you believe that 5G can weaken the immune system or directly cause viral infections? Please express your opinion on this matter.",  role="user")

# 获取当前时间并格式化为文件名的一部分
current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
filename = f"A_5G{current_time}.csv"
