...
BACKGROUND_2 = "QAnon is a belief that suggests a global elite is secretly controlling the world, and certain figures are opposing them. Some people claim that this elite is involved in major global events and hidden activities."
...
ACTION_2 = "You should state at the top of your sentence whether you believe or not believe in the core QAnon conspiracy theory that a global elite is secretly controlling the world. You should keep arguing with the other party until you are convinced by the other party or the other party is convinced by you."
...
msg = Msg(name="host", content="Do you believe that a global elite is secretly controlling the world? Please express your opinion on this matter.",  role="user")

# 获取当前时间并格式化为文件名的一部分
current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
filename = f"A_QAnon_{current_time}.csv"
