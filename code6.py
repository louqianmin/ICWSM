...
BACKGROUND_2 = "Superfoods (such as blueberries, chia seeds, etc.) are considered by some articles and studies to have special effects, and even claim that they can prevent or treat various diseases. These foods are widely recommended for their miraculous health benefits."
...
ACTION_2 = "You should state at the top of your sentence whether you believe or not believe that Superfoods have wonders for health. You should keep arguing with the other party until you are convinced by the other party or the other party is convinced by you."
...
msg = Msg(name="host", content="Do you believe that Superfoods have wonders for health? Please express your opinion on this matter.",  role="user")

# 获取当前时间并格式化为文件名的一部分
current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
filename = f"A_SUPERFOOD{current_time}.csv"
